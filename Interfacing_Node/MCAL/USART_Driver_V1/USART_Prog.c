...
/*********************************************************************************************/
/*
 * Use this function to send data using the USART.
 * it takes:
 * 			- The data to be sent (u16).
 * it returns:
 * 			- An error status.
 */
...
/*********************************************************************************************/
/*
 * Use this function to receive data using the USART.
 * it takes:
 * 			- Pointer to the variable that stores the data (pointer to s16).
 * it returns:
 * 			- An error status.
 */
...
/*********************************************************************************************/
/*
 * Use this function to receive data with interrupt using the USART.
 * it takes:
